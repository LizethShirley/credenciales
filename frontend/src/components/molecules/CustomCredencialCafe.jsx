...
const CustomCredencialCafe = ({ persona, lado }) => {
    ...
    <Box
      sx={{
        ...
        backgroundImage: `url(${lado === 'anverso'
          ? '/credenciales/CARA_CANDIDATO_EG2025.jpg'
          : '/credenciales/ATRAS_CANDIDATO_EG2025.jpg'})`,
...
export default CustomCredencialCafe;