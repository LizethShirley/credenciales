...
const CustomCredencialGuindo = ({ persona, lado }) => {
    ...
    <Box
      sx={{
        ...
        backgroundImage: `url(${lado === 'anverso'
          ? '/credenciales/CARA_OBSERVADOR_EG2025.jpg'
          : '/credenciales/ATRAS_OBSERVADOR_EG2025.jpg'})`,
...
export default CustomCredencialGuindo;