...
const CustomCredencialCafeOscuro = ({ persona, lado }) => {
    ...
    <Box
      sx={{
        ...
        backgroundImage: `url(${lado === 'anverso'
          ? '/credenciales/CARA_DELEGADO_EG2025.png'
          : '/credenciales/ATRAS_DELEGADO_EG2025.png'})`,
...
export default CustomCredencialCafeOscuro;